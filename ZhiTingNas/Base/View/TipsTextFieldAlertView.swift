...
class TipsTextFieldAlertView: UIView {
    ...
    @discardableResult
    static func show(message: String, sureCallback: ((_ pwd: String) -> ())?, cancelCallback: (() -> ())? = nil, removeWithSure: Bool = true) -> TipsTextFieldAlertView {
        let tipsView = TipsTextFieldAlertView(frame: CGRect(x: 0, y: 0, width: Screen.screenWidth, height: Screen.screenHeight), message: message)
    ...
    @discardableResult
    static func show(attributedString: NSAttributedString, chooseString: String,sureCallback: ((_ pwd: String) -> ())?, cancelCallback: (() -> ())? = nil, removeWithSure: Bool = true) -> TipsTextFieldAlertView {
        let tipsView = TipsTextFieldAlertView(frame: CGRect(x: 0, y: 0, width: Screen.screenWidth, height: Screen.screenHeight), attributedString: attributedString)
        tipsView.removeWithSure = removeWithSure
        tipsView.sureCallback = sureCallback
        tipsView.cancelCallback = cancelCallback
        tipsView.textField.becomeFirstResponder()
