...
class GoBackupListResponse: BaseModel {
    var UploadOnFailList = [GoFileUploadInfoModel]()
    var UploadOnGoingList = [GoFileUploadInfoModel]()
    var UploadOnSuccessList = [GoFileUploadInfoModel]()
    var OnGoingNum = 0
}
