...
//  ZhiTingNas
//
//  Created by macbook on 2021/7/1.
//
...
class StoragePoolCollectionView: UIView {
    ...
    public func setModel(model:StoragePoolModel){
        ...
        addBtn.isHidden = (model.name == "__default__")
...
//            }
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        if currentModel.lv[indexPath.row].name == "__default__" || !currentModel.lv[indexPath.row].status.isEmpty{
            return
        }
